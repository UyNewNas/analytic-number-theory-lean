...
* `anthropics/formal-math@fbdc36bbf17d20af3fd0447c6d1a8a02773c9844`,
  `zeta23/Zeta23/ThmE/LGrowth.lean`, declarations
  `norm_LFunction_sub_one_le`, `LFunction_lower_bound_two`, and
  `LFunction_ne_zero_of_two_le_re`;
* pinned Mathlib `e4c91783ca8e6a7c693ae624ade32fd22d4e43c1` supplies the
...
* canonical same-revision `subfish-zhou/goldbach-lean@09b97db5764ade1246bfb77206baa1b124760958`
  contains no competing packaged theorem with this Jensen-centre interface.

The zeta-23 repository uses a different Mathlib revision, so no module is
imported wholesale.  The neutral proof below is the same proof previously
compiled and axiom-audited on ANT PR #76, now restored on current stable main.
No GRH, primitivity, or project-specific hypothesis is used.
-/
